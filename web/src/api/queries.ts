...
export function useSessions(
  ...
  return useQuery<SessionOut[]>({
    ...
    queryFn: async () => {
      const { data, error } = await api.GET(
        '/api/instances/{instance_id}/sessions',
        {
          params: {
            path: { instance_id: id! },
            query: {
...
export function usePlayers(
  id: number | null,
  params: { sort_by: PlayerSortKey; order: Order },
) {
  return useQuery<LocationPlayerOut[]>({
    ...
    queryFn: async () => {
      const { data, error } = await api.GET(
        '/api/instances/{instance_id}/players',
        {
          params: {
            path: { instance_id: id! },
...
export function useVisitors(
  ...
  return useQuery<VisitorOut[]>({
    ...
    queryFn: async () => {
      const { data, error } = await api.GET(
        '/api/instances/{instance_id}/visitors',
        {
          params: {
            path: { instance_id: id! },
            query: { sort_by: params.sort_by, order: params.order },
